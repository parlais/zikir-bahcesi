# Zikir Bahçesi — Mekân kurgusu ve dayanakları
...
- **Ana öğeler:**
  ...
  - dört ırmak: su, süt, bal ve yakut renkli bir şerbet
  - kat kat köşkler
  - altın ve gümüş tuğla, inci ve yakut süsler
  - inci çadırlar, Selsebil, uzayan gölgeler, dal basmış meyveler
- **Görsel ilke:** Tanıdık biçimler, dünyada görülmemiş nitelik ve ışık (Muhammed 15, not 6). Gerçekçi değil, rüya gibi bir temsil (İbn Abbas; Secde 17). Hedef çıta İnsan 20: "Ne tarafa baksan hayale gelmez nimetler, ihtişam ve büyük bir saltanat görürsün."

## Kur'an, hadis ve Risale-i Nur dayanakları
...
Cennette gece-gündüz ve mevsim olmadığı için şu öğeler mevcut hâlleriyle çelişiyor:
- kar örtüsü (Gaffâr)
- sonbahar yaprak dökümü (Kâbıd)
- yıldızlı gece göğü (Kayyûm)
- şafak gökyüzü (Felak)
- şimşek (Muktedir)
- çiy taneli sabah (Gafûr)
- parlak güneşli gün (Zâhir)
- gökyüzü sureleri (Duhâ, Kamer, Necm)

Bu öğelerin nasıl dönüşeceği ya da yerine ne geleceği kullanıcı ve danışma kuruluyla karara bağlanacak. Örnek: kar yerine inci tanesi yağışı, şimşek yerine nur hüzmesi.

## Kaynaklar
- Kullanıcının paylaştığı yazı: "Cennette gece-gündüz, kış-yaz gibi doğa olayları var mı?" (Sorularla İslamiyet)
- Ali Ünal: *Kur'ân-ı Kerîm ve Açıklamalı Meali*, *Risale-i Nur'da Küllî Kaideler 1-3*, *Hizmet Rehberi*. Kullanıcı epub olarak yükledi; dosyalar depoda değildir. Yeni araştırma için tekrar yüklenmeleri gerekir.
- Risale-i Nur: Onuncu Söz, Yirmi Sekizinci Söz. Web arama özetlerinden: risale.online, sorularlarisale.com, risalehaber.com, nurpedia.org.
